...
fn apply_audit_links(opportunity: &mut AdvisoryAuditOpportunity, links: &AuditLinksRow) {
    ...
    opportunity.selected_save_observation =
        links
            .observation_id
            .map(|id| AdvisorySelectedSaveObservation {
                id,
                target_revision: links
                    .observation_target_revision
                    .expect("observation revision"),
                ...
                reason_codes: links
                    ...
                    .clone()
                    .expect("observation reasons"),
                evidence_digest: links
                ...
                qualification: links
                    ...
                    .clone()
                    .expect("observation qualification"),
